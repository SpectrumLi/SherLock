// <copyright file="InstrumentationResult.cs" company="Microsoft Research">
...
namespace TorchLite
{
    ...
    public enum InstrumentationResult
    {
        ...
        /// <summary>
        /// Skipped instrumentation because the assembly does not contain a test of known frameworks
        /// </summary>
        SKIPPED_NotATestAssembly,
    }
}
